    ...
    render() {
        ...
        return (
            ...
            <div className="bgStyle">
                ...
                <Link exact to='/404'><div className="hiddenRabbitPosition" ><img className="hiddenRabbit" src={"https://peepoodo.github.io/peepoodo-box/avatars/lapin.png"} alt="rabbit" /></div></Link>
                <div className='question'>
                    <h1 className="borderTitle titleQuestion"><img className="imgApi" src={this.state.charac1} alt='charac' />Question 1</h1>
                ...
                <div className='question'>
                    <h1 className='titleQuestion'> <img className="imgApi" src={this.state.charac2} alt='charac' />Question 3</h1>
                ...
                <div className='question'>
                    <h1 className='titleQuestion'><img className="imgApi" src={this.state.charac3} alt='charac' />Find me</h1>
